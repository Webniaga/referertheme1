...
function mfn_product_cat_content_form_fields( $array ) {
    ...
    if( !empty($_GET['taxonomy']) && !empty($_GET['tag_ID']) && $_GET['taxonomy'] == 'product_cat' ) {
	    ...
	    echo '<tr class="form-field mfn-wp-form-multifields"><th valign="top" scope="row"><label>Description readmore</label></th><td>
    	...
    	echo '<tr class="form-field mfn-wp-form-multifields mfn-desc-readmore-additional-fields" style="display: none;"><th valign="top" scope="row"><label>Button label</label></th><td>
    		<div class="form-group"><div class="form-control"><input class="mfn-field-value mfn-form-control mfn-form-input" type="text" value="'.( !empty($val_3_button) ? $val_3_button : 'Readmore' ).'" name="mfn_product_cat_desc_button" placeholder="Readmore"></div></div>
      ...
      echo '<div class="form-field mfn-wp-form-multifields"><label>Description readmore</label>
    	...
    	<div>
    		<div class="form-group"><div class="form-control"><input class="mfn-field-value mfn-form-control mfn-form-input" type="text" value="Readmore" name="mfn_product_cat_desc_button" placeholder="Readmore"></div></div></div>
...
function mfn_save_product_cat_fields( $id ) {
  ...
  if(!empty($_POST['mfn_product_cat_desc_readmore'])) { 
  	...
  	$helper_array['mfn_product_cat_desc_button'] = !empty($_POST['mfn_product_cat_desc_button']) ? $_POST['mfn_product_cat_desc_button'] : 'Readmore';
