...
<?php 
	...
	if( !empty($product_gallery_grid_cols_tablet) ) {
		echo '.column_product_images .mfn-product-images-wrapper .mfn-product-gallery-grid{ column-count: '.$product_gallery_grid_cols_tablet.'; }';
	}
...
if( !empty($product_gallery_grid_cols) ) {
	echo '.column_product_images .mfn-product-images-wrapper .mfn-product-gallery-grid{ column-count: '.$product_gallery_grid_cols.'; }';
}
...
@media only screen and ( max-width: 767px ){
	...
	if( !empty($product_gallery_grid_cols_mobile) ) {
		echo '.column_product_images .mfn-product-images-wrapper .mfn-product-gallery-grid{ column-count: '.$product_gallery_grid_cols_mobile.'; }';
	}
